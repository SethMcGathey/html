				...
				<div class="col-lg-3">
					...
					<?php
						//echo $_SESSION['customerid'];
		               	$sql = "SELECT c.id, street_one, street_two, zipcode, city, state, country FROM customer_address c JOIN address a ON c.address_id = a.id WHERE customer_id = " . $_SESSION['customerid'];
		               	foreach ($pdo->query($sql) as $row) {
			               	echo '<a href="setAddress.php?cutomerAddressid=' . $row['id'] . '">
