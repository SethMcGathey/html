...
<html lang="en">
	...
	<form action='zipFiles.php' method="Post">
		...
		<div class="header">
			<p><a href="javascript:void(0);" onclick="runCode();">Run </a></p>
			<p><a href="javascript:void(0);" onclick="saveStrings();">Save </a></p>
			<p><a href="javascript:void(0);" onclick="forkBranch();">Fork </a></p>
